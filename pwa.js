...
const cacheName = 'HelloWorld-2021-03-22 15:25:56.425392'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'HelloWorld'.length) === 'HelloWorld') {
